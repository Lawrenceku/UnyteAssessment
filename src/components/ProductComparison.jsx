...
const ProductComparison = ({ product }) => {
  ...
  return (
    <div className="my-80  relative flex w-96  flex-col  bg-white bg-clip-border text-gray-700 border-x-2 ">
      <div className=" mx-4 mt-4  w-40 h-40 overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700">
