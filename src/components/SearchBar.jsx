            ...
            <div className='bg-[#050505] p-4'>
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="relative">
                        ...
                        <input onChange={(event)=>setSearchItem(event.target.value)} type="search" id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-unyteGreen focus:border-[#5CC048] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search products..." required />
                        <button  className="text-white absolute right-2.5 bottom-2.5 bg-unyteGreen hover:bg-[#5CC048] focus:ring-4 focus:outline-none focus:ring-[#5CCf98] font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                    </div>
            </div>
            </div>
            <div className="flex md:flex-row flex-wrap justify-center items-baseline md:items-start md:justify-between items">
               {
