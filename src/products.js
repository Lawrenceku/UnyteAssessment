export const products = [
    ...
    {
      id: 2,
      name: "Unisex Gridding Sports Baseball Face Cap - Black",
      price: "$2.99",
      description:
    ...
    {
      id: 3,
      name: "Big Face Men's Watch Waterproof Quartz Wristwatch- Black",
      price: "$2.99",
      description:
    ...
    {
      id: 5,
      name: "Apple IPhone 13 Pro Max - 6.7'' - 6GB RAM, 128GB ROM, 5G - Blue",
      price: "$699.99",
      description:
      ...
      image: 'https://ng.jumia.is/unsafe/fit-in/300x300/filters:fill(white)/product/42/7052472/1.jpg?8790',
    },
    {
      id: 6,
      name: "Men Lightweight Winter Varsity Jacket - White",
      price: "$3.99",
      description:
    ...
    {
      id: 7,
      name: "ASHION Casual Sneakers: Stylish Suede Design For Superior Comfort And Durabilit",
      price: "$8.99",
      description:
    ...
    {
      id: 9,
      name: "Ninja 3 IN 1 FOOD PROCESSOR AND BLENDER",
      price: "$170.99",
      description:
